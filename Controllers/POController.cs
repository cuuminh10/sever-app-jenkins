...
namespace gmc_api.Controllers
{
    ...
    public class POController : ControllerBase
    {
        ...
        public POController(ISimpleService service, ISystemCommonService commonService)//, IProductionOrderService producservice)
        {
            _service = service;
        ...
        public IActionResult GetData([FromQuery] ApproveSearchBase searchCondition)
        {
            ...
            if (searchCondition.isApprove == 0)
            {
                ...
                var result = _service.getAPPOMyData(userInfo.UserName, searchCondition, empInfo == null ? -1 : empInfo.employeeId);
                return Ok(result);
            }
            else
            {
                ...
                return Ok(_service.getAPPOApproveData(userInfo.UserName, searchCondition));
            }
        }
        ...
        {
            return Ok(_service.getDetailAPPOItems(id));
        }
    }
}
